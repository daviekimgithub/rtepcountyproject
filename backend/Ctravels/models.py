...
class StationFuelRefill(models.Model):
    name = models.CharField(max_length=100)
    vendor_id = models.ForeignKey(FuelVendor, on_delete=models.CASCADE)
    fuel_station = models.ForeignKey(FuelStation, on_delete=models.CASCADE)
...
class VehicleFuelRefill(models.Model):
    ...
    issued_by = models.ForeignKey(FuelVendor, on_delete=models.CASCADE)
...
class DriversFuelOrder(models.Model):
